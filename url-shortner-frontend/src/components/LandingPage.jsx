        ...
        <div className="min-h-[calc(100vh-64px)]  lg:px-14 sm:px-8 px-4">
            <div className="lg:flex-row flex-col    lg:py-5   pt-16   lg:gap-10 gap-8 flex justify-between items-center">
                <div className=" flex-1">
                    ...
                    >
                        PocketLink Simplifies URL Shortening For Efficient Sharing.
                    </motion.h1>
                    <p className="text-slate-700 text-sm my-5">
                        PocketLink streamlines the process of URL shortening, making sharing
                        links effortless and efficient. With its user-friendly interface,
                        PocketLink allows you to generate concise, easy-to-share URLs in
                        seconds. Simplify your sharing experience with PocketLink today.
                    </p>
