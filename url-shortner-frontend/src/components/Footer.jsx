...
const Footer = () => {
    return (
        <footer style={{ backgroundImage: "linear-gradient(to right, #3b82f6, #9333ea)" }} className="text-white py-8 z-40 relative">
            <div className="container mx-auto px-6 lg:px-14 flex flex-col lg:flex-row lg:justify-between items-center gap-4">
                <div className="text-center lg:text-left">
                    <h2 className="text-3xl font-bold mb-2">PocketLink</h2>
